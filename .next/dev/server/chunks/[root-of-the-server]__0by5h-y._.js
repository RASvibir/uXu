...
(()=>{
    const e = new Error("Cannot find module '../../../lib/token.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
async function POST(req) {
    ...
    const u = await db.master.findUnique({
        where: {
            email: b.email
        }
    });
    ...
    const good = await v(b.password, u.password);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0by5h-y._.js.map
...
| **CyberCat Deck Builder** | Make a CyberCat deck (`DECK`) — your files/links. Names unique on this device (`deck exists` if repeated). Examples: antelope, ur mom, bout treefiddy. Default look Lathe, not Sunflower CRT. Bolt is a wordmark a hair taller than type, not the favicon. |

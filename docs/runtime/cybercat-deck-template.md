...
- Deck Builder (`archives/CyberCat-Deck-Builder/`) is a spawn *host*, not a
  spawned room: unique rest-of-names on the device; skull-and-roses bolt
  wordmark (clear field, slight right tilt); empty-deck look is Lathe (no Sunflower CRT packs).

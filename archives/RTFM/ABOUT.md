...
uXu is a **shared archive commons**. Independent archives keep their own voice,
stack, and curation. Nobody takes your collection away from you.

- **uXu** (landing / installable app) — public invite into the commons  
- **0?0** (`0?0.uXu.0000`) — root console once you are inside  
...
0?0 is the front desk of the commons:
...
The first non-root room was **CyberCat Sunflower** — proof a full personality
can live under the commons. **0?0** grew as the center: look things up, open a
door, read a manual, leave a trail.

Design bets:

- Forever ids — history should not vanish when access does  
- Simple first — folder, page, list; complexity optional  
- Keyboard-honest console — a tool, not only a brochure  
- Public invite ≠ root console — share **uXu**; work inside **0?0**  
